      ...
      <div className="flex flex-col justify-center max-w-xs mx-auto bg-white shadow-2xl rounded-xl p-5">
        ...
        <div className="text-center mt-5">
          ...
          <div className="flex align-center justify-center mt-4">
            <a
              className="text-xl m-1 p-1 sm:m-2 sm:p-2 text-gray-800 hover:bg-gray-800 rounded-full hover:text-white transition ease-in-out delay-900 hover:-translate-y-1 hover:scale-110 duration-300"
            ...
            <a
              className="text-xl m-1 p-1 sm:m-2 sm:p-2 text-blue-600 hover:bg-blue-600 rounded-full hover:text-white transition ease-in-out delay-900 hover:-translate-y-1 hover:scale-110 duration-300"
